...
const DashboardLanding = lazy(() => import("./components/dashboard/landing/dashboard"));
const EnvironmentalDashboard = lazy(() => import("./components/dashboard/environmental/environmental"));
